...
const TeacherProfilePage: React.FC = () => {
  ...
  // Fetch the logged-in teacher's own record from the Teachers collection
  // (the record itself is created/managed by an admin — this page only
  // reads it and lets the teacher update their own contact details and
  // password).
  useEffect(() => {
  ...
  const handleEditProfile = async (e: React.FormEvent) => {
    ...
    if (!editForm.fullName || !editForm.subject) {
      setEditError('Full name and subject are required.');
      setEditLoading(false);
      return;
    }

    try {
      // Updates the teacher's own record by their teacher _id.
      const res = await fetch(`/api/teachers/${profile?._id}`, {
        method: 'PUT',
        headers: {
  ...
  const handleChangePassword = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Teacher record itself, so this goes through the shared
    ...
    <div className="mgmt-page">
      ...
      <div className="profile-overview">
        ...
        <div className="profile-info">
          ...
          <p className="username">{profile.teacherId}</p>
        </div>
      </div>
      ...
      <div className="profile-grid-columns">
        ...
        <div className="profile-section">
          ...
          {isEditingProfile ? (
            ...
            <div className="profile-display">
              ...
              <div className="profile-row">
                <span className="profile-label"><BookOpen size={14} /> Subject</span>
        ...
        <div className="profile-section">
          ...
          <div className="profile-display">
            <div className="profile-row">
              <span className="profile-label"><Hash size={14} /> Teacher ID</span>
              <span className="profile-value">{profile.teacherId}</span>
            </div>
            <div className="profile-row">
